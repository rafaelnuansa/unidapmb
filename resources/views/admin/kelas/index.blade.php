                ...
                <tbody>
                    @forelse ($classes as $class)
                        <tr>
                            ...
                            <td>{{ $class->name }}</td>
                            <td>
                                <a href="{{ route('admin.kelas.edit', $class->id) }}" class="btn btn-warning">Edit</a>
                                <form action="{{ route('admin.kelas.destroy', $class->id) }}" method="POST" style="display: inline-block;">
                                    @csrf
                                    @method('DELETE')
