...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Create Fakultas') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.fakultas.store') }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="codename" type="text" class="form-control @error('codename') is-invalid @enderror" name="codename" value="{{ old('codename') }}" required>
