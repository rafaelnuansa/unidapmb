                        ...
                        <div class="lg:max-w-lg lg:mx-auto lg:me-0 ms-auto">
                            ...
                            <div class="p-4 sm:p-7 flex flex-col bg-white rounded-2xl shadow-lg dark:bg-slate-900">
                                <div class="text-center">
                                    <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Login
                                    </h1>
                                </div>
                                ...
                                <div class="mt-5">
                                    ...
                                    <div class="flex justify-between mt-3">
                                        <div class="text-sm">
                                            <label for="forgot-password" class="text-blue-600 hover:underline font-medium dark:text-white">
                                                <a href="#">Lupa password?</a>
                                            </label>
                                        </div>

                                        <div class="text-sm">
                                            <label for="register" class="text-blue-600 hover:underline font-medium dark:text-white">
